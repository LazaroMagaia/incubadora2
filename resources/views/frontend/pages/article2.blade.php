    ...
    <main class="container mx-auto mt-8 flex py-10">
        <article class="w-3/4 p-4 bg-white rounded-lg shadow-md">
            ...
            <p class="mb-4 text-md font-light">
                A visita da Universidade de Tallinn à Incubadora de Negócios da UEM marca um importante intercâmbio
                acadêmico e empresarial. Durante a visita, representantes da universidade exploraram as instalações
                da incubadora, conheceram as startups em desenvolvimento e discutiram oportunidades de colaboração 
                em pesquisa e inovação. O encontro visa fortalecer laços internacionais, compartilhar experiências 
                e promover o empreendedorismo, contribuindo para o crescimento de novas iniciativas e o fortalecimento
